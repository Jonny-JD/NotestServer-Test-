...
public class MenuButtonsAside {
    ...
    public final ElementsCollection actualButtons;

    public MenuButtonsAside() {
        this.actualButtons = $(By.className("aside-interaction-buttons")).findAll("button");
